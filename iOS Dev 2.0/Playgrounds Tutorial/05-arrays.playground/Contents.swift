...
var donutNames = ["number1", "number2", "number3", "number4", "number5", "number6"]
var countD = [12,24,32,45,51,65]

print(donutNames)
print(countD)

donutNames.remove(at: donutNames.count - 1 )
countD.remove(at: countD.count - 1)

print(donutNames)
print(countD)


donutNames.insert("number0", at: 0)
countD.insert(0, at: 0)
